  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10 max-w-base mx-auto mt-24  px-2 base:px-0 items-center justify-items-center md:justify-items-start">
      <div>
        ...
        <h2 className="font-bold text-4xl mt-1">Do dzisiaj wyprodukowaliśmy</h2>
        <p className="mt-14">
      ...
      <div>
        ...
        <h2 className="font-bold text-4xl sm:text-5xl mt-1">Dla producentów z krajów</h2>
        <p className="mt-14">
      ...
      <div>
        ...
        <h2 className="font-bold text-4xl sm:text-5xl mt-1">Liderzy naszych zespołów</h2>
        <p className="mt-14">
          Belgia, Francja, Niemcy, Włochy, Kanada, Wielka Brytania, Hiszpania,
          Słowacja, Czechy, Indie, Iran, Luksemburg, Izrael i Polska.
        </p>
      ...
      <div>
        ...
        <h2 className="font-bold text-4xl sm:text-5xl mt-1">Z reżyserami m.in.</h2>
        <p className="mt-14">
